...
<head>
    ...
    <link rel="stylesheet" href="css/style_lk-applicant.css">
        ...
        <div class='head'>
            <div class="menu">
                ...
                <ul class='head-menu'>
                    ...
                    <li class="head-menu_point"><a href= "lk_applicant.php" name='lk' class="link">Личный кабинет</a></li>
                </ul>
                </div>
            </div>
    </header>
                ...
                <div class=form-input><div class="form_text">Имя: </div><div class="form-input_text"><input class="resume" type="text" name="second" value="" placeholder="Введите имя"required><br></div></div>
                    <div class=form-input><div class="form_text">Отчество: </div><div class="form-input_text"><input class="resume" type="text" name="father" value="" placeholder="Введите отчество"required><br></div></div>
                        <div class=form-input><div class="form_text">Номер телефона: </div><div class="form-input_text"><input class="resume" type="phone" name="phone" value="" placeholder="Номер телефона"required><br></div></div>
                            <div class=form-input><div class="form_text">Информация о себе: </div><div class="form-input_text-info"><input class="resume info" type="text" name="inform" value="" placeholder="Информация о себе"required><br></div></div>
                                <div class=form-input><div class="form_text">Пол: </div><div class="form-input_text">Мужской: <input type="radio" name="sex"required> Женский: <input type="radio" name="sex"required><br></div></div>
                                    <div class=form-input><div class="form_text">Желаемая должность: </div><div class="form-input_text"><input class="resume" type="text" name="vac" value="" placeholder="Введите желаемую должность"><br></div></div>
                                        <div class=form-input><div class="form_text">Дата рождения: </div><div class="form-input_text-date"><input class="resume" type ="date" name="date" value=""required></div></div>
                                        <div class=form-input><div class="form_text">Ваша специальность: </div><div class="form-input_text"><input class="resume" type ="text" name="learn" value="" placeholder="Введите специальность"required></div></div>
